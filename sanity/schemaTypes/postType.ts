    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: "Real Estate Banking", value: "real-estate-banking" },
          { title: "Real Estate Investing", value: "real-estate-investing" },
          { title: "Rental Market Trends", value: "rental-market-trends" },
          { title: "Rent Collection", value: "rent-collection" },
          { title: "Software Comparisons", value: "software-comparisons" },
          { title: "Taxes and Reporting", value: "taxes-and-reporting" },
        ],
      },
      validation: (rule) => rule.required(),
    }),
